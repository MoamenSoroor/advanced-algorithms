...
namespace AdvancedDSA.Models
{
    ...
    public class MapPath
    {
        ...
        public static double CalculatePathLength(MapPath path)
        {
            ...
            var len = path.positions.Zip(path.positions.Skip(1).Append(path.positions.First()))
        ...
        public static MapPath Create(MapPath path, ImmutableList<(int Index, int NewIndex)> swaps)
        {
            ...
            return Create(list.ToImmutableList());
        }
        ...
        private MapPath(ImmutableList<Point> positions)
        {
            ...
            pathLength = CalculatePathLength(this);
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            {
                return path.Positions.SequenceEqual(positions);
            }
            return false;
        }
